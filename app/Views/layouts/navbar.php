            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="search_bar dropdown show">
                        <img src="<?= base_url('assets/images/Logo_Caffeind.png') ?>" alt="logo" style="width: 50px; height: auto; margin-right: 10px;">
                        <img src="<?= base_url('assets/images/Caffeind.png') ?>" alt="logo" style="width: 100px; height: auto;">
                    </div>
                </div>
